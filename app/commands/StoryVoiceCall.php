...
class StoryVoiceCall extends Command {
         ...
         * @var string
         */
	protected $name = 'voicecall:story';
    ...
    public function fire()
        {
                ...
                $query2 = "update motech_data_services.tmp_user set msg_file=concat('Week',story_week,'Story',story_week), story_week=story_week+1";
                DB::statement($query2);
