...
class SyncCleanUps extends Command {
	...
	protected $name = 'sync:cleanups';
         ...
         * @var string
         */
	protected $description = 'To sync and clean data for processing';
	...
	/**
        ...
        public function fire()
        {
                ...
                // Trim left and right spaces of phone numbers
                $query1 = "update table set noyawa.clients_sms_registration = LTRIM(RTRIM(client_number))";
                DB::statement($query1);
