              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="/feedback"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">{{$inboxCount}}</span></a></li>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            oTable = $('#logstable').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "{{ URL::to('/getsynclogs') }}"
            });
