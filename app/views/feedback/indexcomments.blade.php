              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li  class="active"><a href="/feedback.comments"><i class="fa fa-circle-o text-yellow"></i> Comments <span class="label label-primary pull-right">{{$commentsCount}}</span></a></li>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            oTable = $('#logstable').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "{{ URL::to('/getcommentssynclogs') }}"
            });
