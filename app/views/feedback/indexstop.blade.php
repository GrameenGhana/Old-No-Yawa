              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="/feedback.stop"><i class="fa fa-circle-o text-light-red"></i> Stop <span class="label label-primary pull-right">{{$stopCount}}</span></a></li>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            oTable = $('#logstable').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "{{ URL::to('/getstopsynclogs') }}"
            });
