              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="/feedback.sentmessages"><i class="fa fa-envelope-o"></i> Sent <span class="label label-primary pull-right">{{$sentCount}}</span></a></li>
                    <li ><a href="/noyawagh/feedback.callmessages"><i class="fa fa-envelope-o"></i> Calls(Incoming) <span class="label label-primary pull-right">{{$callsCount}}</span></a></li>
                    <li class="active"><a href="/feedback.trashmessages"><i class="fa fa-trash-o"></i> Trash <span class="label label-primary pull-right">{{$trashCount}}</span></a></li>
                  </ul>
                </div><!-- /.box-body -->
              </div><!-- /. box -->
              <div class="box box-solid">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            oTable = $('#logstable').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "{{ URL::to('/gettrashsynclogs') }}"
            });
