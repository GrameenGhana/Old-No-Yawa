              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="/feedback.others"><i class="fa fa-circle-o text-light-blue"></i> Others  <span class="label label-primary pull-right">{{$othersCount}}</span> </a></li>
                  </ul>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            oTable = $('#logstable').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "{{ URL::to('/getotherssynclogs') }}"
            });
