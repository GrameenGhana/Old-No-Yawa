          ...
          <div class="row">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="/feedback.callmessages"><i class="fa fa-envelope-o"></i> Calls(Incoming) <span class="label label-primary pull-right">{{$callsCount}}</span></a></li>
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">All Responses for <b>{{$from}}</b></h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            oTable = $('#logstable').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "http://localhost:8000/getallresponsessynclogs?id={{$id}}"
            });
