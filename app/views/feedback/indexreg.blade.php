          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="/feedback.registration"><i class="fa fa-circle-o text-green"></i> Registration <span class="label label-primary pull-right">{{$regCount}}</span></a></li>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            oTable = $('#logstable').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "{{ URL::to('/getregsynclogs') }}"
            });
