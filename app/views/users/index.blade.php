    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <h2 class="page-header">
                <a class="btn btn-small btn-success" href="{{ URL::to('system_setup/users/create') }}"><i class="fa fa-plus-circle"></i> Add a User</a>
            </h2>
            @endif
        </div><!-- /.col -->
    </div>
                ...
                <table id="userstable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="Edit" class="btn btn-sm btn-info" href="{{ URL::to('system_setup/users/' . $value->id . '/edit') }}"><i class="fa fa-pencil"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
