...
class HomeController extends BaseController {
    ...
    public function showHome() {
        ...
        $subscribersCount = DB::table('clients_sms_registration')->count();
        
        
        //checking balance from txtconnect api
        $url = 'http://txtconnect.co/api/balance/';
        $result = file_get_contents($url . "?token=" . urlencode('4401410c4bd4edccc449ed77a63f2f644e7870e0'));
        ...
        if ($credit >= ($subscribersCount * 3)) {
            $flag = "0"; //to show green color :: alert-info
        }else if($credit >= ($subscribersCount * 2)){
            $flag = "1"; //to show yellow color :: alert-warning
        }else if($credit <= $subscribersCount ){
            $flag = "2"; //to show red color :: alert-danger
        }
        ...
        $data = array('flag'=>$flag,"credit"=>$credit,"subscribersByAge"=>$subscribersByAge,"subscribersByChannel"=>$subscribersByChannel,"subscribersByOperator"=>$subscribersByOperator);
        //$data = array('flag'=>$flag,"credit"=>$credit);
