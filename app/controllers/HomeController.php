...
class HomeController extends BaseController {
    ...
    public function DateDiff($date1, $date2, $format='long')
	{
		...
		if ($t  >= 1) { 
		    ...
		    $years = (($years*12) >= $f) ? $years : $years+floor($t);
	        }
    ...
    public function getSubscribersByStatus(){
        ...
        $chartArray["series"][] = array("type" => "pie", 'name' => "Registrants By Status", "data" => [array("name" => "Graduants", "y" => $subsGraduants), array("name" => "Active", "y" => $subsActive),
                array("name" => "Ineligible", "y" => $subsIneligible)]);
